...
class Imports {
    ...
    add(param, typeOnly) {
        ...
        if (typeof param === 'string') {
            // A model
            imp = new Import(param, (0, gen_utils_1.unqualifiedName)(param, this.options), (0, gen_utils_1.qualifiedName)(param, this.options), 'models/', (0, gen_utils_1.modelFile)(param, this.options), typeOnly);
        }
        else {
            // An Importable
            imp = new Import(param.importName, (_a = param.importTypeName) !== null && _a !== void 0 ? _a : param.importName, (_b = param.importQualifiedName) !== null && _b !== void 0 ? _b : param.importName, `${param.importPath}`, param.importFile, typeOnly);
        }
